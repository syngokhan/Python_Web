...
# if select sqlite3 remove with connection.cursor() as cursor :  
# change cursor.execute -- > connection.execute()   
...
def get_movies(upcoming = False):
    with connection:
        with connection.cursor() as cursor:
            # if select sqlite3 add cursor and remove with connection.cursor() as cursor :     
            #cursor = connection.cursor()
            if upcoming:
                #2022-03-23 18:06:00.639827 1648047960.639834
